...
public class CamadaAplicacaoTransmissora{
  ...
  //Construtor:
  public CamadaAplicacaoTransmissora(CamadaFisicaTransmissora camada_Fisica_Transmissora){
  ...
  public void camadaAplicacaoTransmissora (String mensagem) {
    ...
    camada_Fisica_Transmissora.camadaFisicaTransmissora(fluxoBrutoDeBits);
