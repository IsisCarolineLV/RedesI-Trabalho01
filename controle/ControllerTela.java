...
public class ControllerTela {
  ...
  @FXML
  private AnchorPane paneSinalBinario;  //mostra o sinal na codificacoes binaria

  @FXML
  private AnchorPane paneSinalManchesters;  //mostra o sinal nas demais codificacoes
  ...
  private ImageView imagemSinal8;
    ...
    //imagens do sinal Manchester e Manchester diferencial
  @FXML
  private ImageView imagemSinalM1;
  
  @FXML
  private ImageView imagemSinalM2;

  @FXML
  private ImageView imagemSinalM3;

  @FXML
  private ImageView imagemSinalM4;

  @FXML
  private ImageView imagemSinalM5;

  @FXML
  private ImageView imagemSinalM6;

  @FXML
  private ImageView imagemSinalM7;

  @FXML
  private ImageView imagemSinalM8;

  @FXML
  private ImageView imagemSinalM9;

  @FXML
  private ImageView imagemSinalM10;
  
  @FXML
  private ImageView imagemSinalM11;

  @FXML
  private ImageView imagemSinalM12;

  @FXML
  private ImageView imagemSinalM13;

  @FXML
  private ImageView imagemSinalM14;

  @FXML
  private ImageView imagemSinalM15;

  @FXML
  private ImageView imagemSinalM16;
  ...
  private ImageView[] sinaisBinario;
  private ImageView[] sinaisManchesters;
  
  private int tipoDeCodificacao = 1;  //salva a codificacao escolhida no comboBox
  ...
  public void criarArraysDeImagens() {
    ...
    imagens[4] = new Image("/imagens/telaMenuOpcao.png");
    ...
    //Array de imageView dos sinais Binarios:
    sinaisBinario = new ImageView[]{imagemSinal1,imagemSinal2,imagemSinal3,
                                    imagemSinal4,imagemSinal5,imagemSinal6,
                                    imagemSinal7,imagemSinal8};
 
    //Array de imageView dos sinais Manchester (com metade da frequencia)
    sinaisManchesters = new ImageView[]{imagemSinalM1,imagemSinalM2,imagemSinalM3,
                                        imagemSinalM4,imagemSinalM5,imagemSinalM6,
                                        imagemSinalM7,imagemSinalM8,imagemSinalM9,
                                        imagemSinalM10,imagemSinalM11,imagemSinalM12,
                                        imagemSinalM13,imagemSinalM14,imagemSinalM15,
                                        imagemSinalM16};
  ...
  public void criarCamadas(){
    // RECEPTOR:
    AplicacaoReceptora aplicacao_Receptora = new AplicacaoReceptora(imagemImpressora, botaoEnviar, textoDecodificado,
        campoDeTexto, botaoVer);

    CamadaAplicacaoReceptora camada_Aplicacao_Receptora = new CamadaAplicacaoReceptora(aplicacao_Receptora);

    CamadaFisicaReceptora camada_Fisica_Receptora = new CamadaFisicaReceptora(camada_Aplicacao_Receptora,
        tipoDeCodificacao, imagemImpressora);

    // MEIO DE COMUNICACAO:
    ImageView[] imagensDoSinal;
    if(tipoDeCodificacao==0){ 
      imagensDoSinal = sinaisBinario;
      paneSinalBinario.setVisible(true);
    }
    else{  
      imagensDoSinal = sinaisManchesters;
      paneSinalManchesters.setVisible(true);
    }
    
    MeioDeComunicacao meioDeComunicacao = new MeioDeComunicacao(tipoDeCodificacao, camada_Fisica_Receptora, 
         imagensDoSinal, barraDeProgresso);

    // TRANSMISSOR
    CamadaFisicaTransmissora camada_Fisica_Transmissora = new CamadaFisicaTransmissora(meioDeComunicacao,
        tipoDeCodificacao);

    CamadaAplicacaoTransmissora camada_Aplicacao_Transmissora = new CamadaAplicacaoTransmissora(
        camada_Fisica_Transmissora);
  ...
  void clicouVoltar(ActionEvent event) {
    ...
    paneFolha.setVisible(false);
    paneSinalBinario.setVisible(false);
    paneSinalManchesters.setVisible(false);
  } //fim do clicouVoltar
